...
class Requests:
    print('-----------------------------------------------------------------------')
    url = 'https://www.youtube.com/'  # Указываем URL, на который будем отправлять GET-запрос
...
class Panda:
    ...
    data = pd.read_fwf(r'C:\Users\admin\PycharmProjects\pythonProject\Readme.txt')
...
class Pillow:
    image = Image.open(r'C:\Users\admin\PycharmProjects\pythonProject\Cat7.jpg')
